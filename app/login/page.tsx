    ...
    <div className="flex flex-col items-center justify-center gap-8 p-8 max-w-sm w-full">
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="text-center">
          <h1 className="text-2xl font-bold text-foreground">UniPlanner</h1>
          <p className="text-muted-foreground text-sm mt-1">Tu planificador universitario personal</p>
        </div>
      </div>
      <div className="card w-full space-y-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 bg-white text-gray-800 hover:bg-gray-50 border border-gray-200 px-4 py-3 rounded-lg font-medium transition-colors"
        >
